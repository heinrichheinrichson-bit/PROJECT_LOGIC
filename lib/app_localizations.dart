...
class AppLocalizations {
  ...
  String known(String value) {
    ...
    const values = <String, String>{
      ...
      'Hundert Tagesrätsel': 'One hundred daily puzzles',
      'Hundertachtzig Tagesrätsel': 'One hundred eighty daily puzzles',
      '365 Tagesrätsel': '365 daily puzzles',
      '730 Tagesrätsel': '730 daily puzzles',
      'Tausend Tagesrätsel': 'One thousand daily puzzles',
